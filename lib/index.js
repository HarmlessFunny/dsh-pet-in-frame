...
const ACTION_KEYS = ['default', 'cordis', 'think', 'bash', 'edit', 'read', 'search', 'learn', 'plan', 'ask', 'subagent', 'error', 'done', 'idle', 'sleep']
...
export function apply(ctx, config = {}) {
  ...
  const state = { status: 'idle', action: 'default', tool: null, toolSince: 0, error: null, errorUntil: 0, idleSince: 0, subagentCount: 0, subagentUntil: 0, subagentActiveUntil: 0 }
